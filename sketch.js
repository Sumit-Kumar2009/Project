var bow , arrow,  scene;
var bowImage, bowAnimation, arrowImage, green_balloonImage, red_balloonImage, pink_balloonImage ,blue_balloonImage, backgroundImage;
...
function preload(){
  ...
  bowAnimation = loadAnimation("bow0.png","bow1.png","bow0.png");
...
function draw() {
 ...
 // moving ground
  ...
  if (keyWentDown("space")) {
    bow.addAnimation("bowlaunch",bowAnimation);
  }
